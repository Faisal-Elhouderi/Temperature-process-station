%% P1 (no delay) identification for 3 datasets
% Creates G1,G2,G3 as tf objects and plots measured temp vs step response of each model.
...
fprintf("\n=========== FINAL P1 TRANSFER FUNCTIONS (NO DELAY) ===========\n");
...
for k = 1:3
    ...
    legend("Measured Temp (resampled)", sprintf("Step of G%d(s)", k), "Location", "best");
end
